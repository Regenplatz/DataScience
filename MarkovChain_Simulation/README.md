...
For calculating the transition probability matrix, the five csv files were read to pandas as DataFrame and initially edited (e.g. new customer IDs ('UniqueID') were generated as customerNo 1 on Monday was not the same as customerNo1 on Tuesday). Afterwards, those 5 DataFrames were merged to one single DataFrame for further processing.
...
#   
### Simulation
To be performed later using [supermarket.png](https://github.com/Regenplatz/DataScience/blob/master/MarkovChain_Simulation/supermarket.png)

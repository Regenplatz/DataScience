...
- use batch normalization (add 2 hyperparameters per layer to normalize the inputs to the activation function to a given scale/average --> reduces training time, improves accuracy)
